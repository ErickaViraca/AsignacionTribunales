...
from docente inner join doc_area on  docente.iddocente= doc_area.docente_iddocente
  ...
  public function enviarEmailDocente($id_docente)
  {
    $docente = new Docente();
    $correo_docente = $docente->getCorreoDocenteById($id_docente);
    $to = (String)$correo_docente;
    $from = 'worldview.umss.2018@gmail.com';
    $subject = 'Sistema de Asignacion de Tribunales - FCyT';
    $body = 'Estimado. Usted fue asignado como tribunal de un proyecto.';
